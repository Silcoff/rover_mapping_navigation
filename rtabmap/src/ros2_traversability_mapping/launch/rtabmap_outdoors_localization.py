...
def generate_launch_description():
    ...
    zed_config_ffmpeg = os.path.join(
        get_package_share_directory('ros2_traversability_mapping'),
        'config',
        'zed2i.yaml'
    )
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            output='screen',
            parameters=[{
                'args': '--Optimizer/GravitySigma 0.3 --Odom/Strategy 1 --Vis/CorType 1 --OdomF2M/MaxSize 1000 --Vis/MaxFeatures 600',
                'localization': True,
        ...
        Node(
            ...
            output='screen',
            parameters=[zed_config_common, zed_config_ffmpeg]
        )
    ])
